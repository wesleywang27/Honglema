...
@section('page-main')
    ...
    <div class="content" style="top: 1.2rem;text-align: center;">
        ...
        <div class="content-block" style="margin-top: -1rem;">
            ...
            <div class="row">
                <div class="col-100"><a id="changehead"   onclick="changeHeadImg()" class="button button-big button-fill button-danger">更改头像</a></div>
                    ...
                    <div class="item-content">
                        <div class="weui_uploader" style="margin-left: .75rem;margin-top: .5rem;margin-right: 1.5rem;width:100%;">
                            ...
                            <div class="weui_uploader_bd">
                                ...
                                <div class="weui_uploader_input_wrp" id="idimgdiv">
                                    <input class="weui_uploader_input" id="idimg" name="imgs[]" type="file" accept="image/jpg,image/jpeg,image/png,image/gif" multiple="">
                                </div>
                                @endif
                            </div>
                        </div>
